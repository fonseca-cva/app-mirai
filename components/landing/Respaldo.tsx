...
export function Respaldo() {
  return (
    <section id="respaldo" className="bg-salvia/15 px-4 py-24 sm:px-8">
      <div className="mx-auto max-w-3xl">
        ...
        <p className="rounded-[14px] bg-blanco-papel p-6 text-center font-display text-lg">{respaldo.cifra}</p>
      </div>
    </section>
  );
}
