...
export function TeaserInforme() {
  return (
    <section className="flex flex-col items-center gap-8 bg-gris-papel px-4 py-24 text-center sm:px-8">
      ...
      <h2 className="text-2xl font-semibold uppercase tracking-[0.2em] sm:text-3xl">{teaserInforme.titulo}</h2>
