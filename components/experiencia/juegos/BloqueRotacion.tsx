...
import { DemoRotacion, DemoPlegado } from "@/components/experiencia/tutorial/Demos";
...
function ImagenEstaticaRotacion() {
  return (
...
// Orquesta "Pliegues en el espacio": tutorial (propósito + demo en loop + 2 prácticas) → 10 ítems reales.
export function BloqueRotacion({ onCompletar }: Props) {
  ...
  if (tutorial.fase === "demo") {
    return (
      <section className="flex min-h-screen flex-col items-center justify-center gap-6 px-4 text-center sm:px-8">
        <BotonSaltarTutorial onSaltar={tutorial.saltarTutorial} />
        <DemoRotacion onCicloCompletado={tutorial.registrarCicloDemo} />
  ...
  if (tutorial.fase === "practica-1" || tutorial.fase === "practica-2") {
    const item = tutorial.fase === "practica-1" ? itemPracticaRotacion : itemPracticaPlegado;
    return (
